...
<link rel="stylesheet" href="{{ asset('asset/backend/plugins/datatables-responsive/css/responsive.bootstrap4.min.css')}}">
<link rel="stylesheet" href="{{ asset('asset/backend/plugins/datatables-buttons/css/buttons.bootstrap4.min.css')}}">
