...
<script src="{{ asset('asset/backend/plugins/jszip/jszip.min.js') }}"></script>
<script src="{{ asset('asset/backend/plugins/pdfmake/pdfmake.min.js') }}"></script>
<script src="{{ asset('asset/backend/plugins/pdfmake/vfs_fonts.js') }}"></script>
<script src="{{ asset('asset/backend/plugins/datatables-buttons/js/buttons.html5.min.js') }}"></script>
<script src="{{ asset('asset/backend/plugins/datatables-buttons/js/buttons.print.min.js') }}"></script>
<script src="{{ asset('asset/backend/plugins/datatables-buttons/js/buttons.colVis.min.js') }}"></script>
...
<script>
  function copyToClipboard() {
      ...
      // Optional: Show a confirmation message or change button text
