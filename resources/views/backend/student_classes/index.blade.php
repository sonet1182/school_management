            ...
            <div class="d-flex">
                <div class="ml-auto">
                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#exampleModal"> <i
                            class="fa fa-plus" aria-hidden="true"></i> Create New Class </button>
                </div>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="bannerForm" class="needs-validation" action="{{ route('classes.store') }}"
...
@section('scripts')
    ...
    <script>
        $(document).on('click', '.edit-btn', function(event) {
            ...
            $.ajax({
                url: "{{ route('classes.edit', ['class' => ':class_id']) }}".replace(':class_id',
                    class_id),
                type: 'GET',
