...
@section('title', 'Sub-Leader')
@section('breadcrumb', 'Sub-Leader List')
    ...
    <div class="card card-default">
            ...
            <div class="d-flex">
                <div class="ml-auto">
                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#exampleModal"> <i
                            class="fa fa-plus" aria-hidden="true"></i> Create New Sub Leader </button>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Create New Sub Leader</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form id="bannerForm" class="needs-validation" action="{{ route('subleaders.store') }}"
        ...
        <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Update Sub Leader</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
@section('scripts')
    ...
    <script>
        $(document).on('click', '.edit-btn', function(event) {
            ...
            var subleader_id = $(this).data('row-id');
            ...
            $.ajax({
                url: "{{ route('subleaders.edit', ['subleader' => ':subleader_id']) }}".replace(':subleader_id',
                    subleader_id),
                type: 'GET',
